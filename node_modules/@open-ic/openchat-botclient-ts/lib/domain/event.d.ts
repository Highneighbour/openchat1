...
export type CommunityEvent = EmptyEvent | GroupChatCreated | CommunityNameChanged | CommunityDescriptionChanged | AvatarChanged | BannerChanged | UsersInvitedEvent | MembersRemoved | MemberJoined | MemberLeft | RoleChanged | UsersBlocked | UsersUnblocked | CommunityVisibilityChanged | GroupInviteCodeChanged | CommunityFrozenEvent | CommunityUnfrozenEvent | GateUpdatedEvent | CommunityPermissionsChanged | ChannelCreated | ChannelDeleted | PrimaryLanguageChanged | GroupImported | BotAdded | BotRemoved | BotUpdated | CommunityRulesChanged;
export type ChatEvent = EmptyEvent | MessageEvent | GroupChatCreated | DirectChatCreated | GroupNameChanged | GroupDescChanged | GroupRulesChanged | AvatarChanged | MembersAdded | MembersRemoved | MemberJoined | MemberLeft | RoleChanged | UsersBlocked | UsersUnblocked | MessagePinned | MessageUnpinned | PermissionsChanged | GroupVisibilityChanged | GroupInviteCodeChanged | ChatFrozenEvent | ChatUnfrozenEvent | EventsTimeToLiveUpdated | GateUpdatedEvent | UsersInvitedEvent | MembersAddedToDefaultChannel | ExternalUrlUpdated | BotAdded | BotRemoved | BotUpdated;
...
export type MessageContent = FileContent | TextContent | ImageContent | VideoContent | AudioContent | DeletedContent | BlockedContent | PlaceholderContent | BotPlaceholderContent | PollContent | CryptocurrencyContent | GiphyContent | ProposalContent | PrizeContent | PrizeContentInitial | P2PSwapContent | P2PSwapContentInitial | PrizeWinnerContent | MessageReminderCreatedContent | MessageReminderContent | ReportedMessageContent | UserReferralCard | MemeFighterContent | VideoCallContent;
...
export type CryptocurrencyTransfer = CompletedCryptocurrencyTransfer | PendingCryptocurrencyTransfer | FailedCryptocurrencyTransfer;
