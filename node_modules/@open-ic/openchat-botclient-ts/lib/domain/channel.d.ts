...
import type { LowercaseChatPermission as ChatPermission, LowercaseMessagePermission as MessagePermission, PermissionRole } from "./permissions";
export type Rules = {
    text: string;
    enabled: boolean;
};
export declare class Channel {
    ...
    toInputArgs(communityId: CommunityIdentifier): LocalUserIndexBotCreateChannelArgs;
}
